...
\begin{parts}
    ...
    \ifans{
    The number of steps required to parse a sentence of n words is 2n because a transition-based parser pushes n words to the stack with SHIFT and removes those n words with the LEFT- or RIGHT-ARC
    }\newline
...
\input{dep_parses.tex}
 ...
 3. 
 - Error type: \\
 - Incorrect dependency: performance $\rightarrow$ tasks\\
 - Correct dependency: \\
 4.
  - Error type: \\
 - Incorrect dependency: crossing $\rightarrow$ eating\\
 - Correct dependency: \\
}\newline
